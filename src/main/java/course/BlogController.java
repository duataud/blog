...
public class BlogController {
    ...
    private final BlogPostDAOImpl blogPostDAOImpl;
    ...
    public BlogController(String mongoURIString) throws IOException {
        ...
        blogPostDAOImpl = new BlogPostDAOImpl(blogDatabase);
        userDAO = new UserDAOImpl(blogDatabase);
        sessionDAO = new SessionDAOImpl(blogDatabase);
    ...
    private void initializeRoutes() throws IOException {
        ...
        get(new FreemarkerBasedRoute("/", "blog_template.ftl") {
            ...
            public void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                ...
                List<DBObject> posts = blogPostDAOImpl.findByDateDescending(10);
        ...
        get(new FreemarkerBasedRoute("/post/:permalink", "entry_template.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer) throws IOException, TemplateException {
                ...
                DBObject post = blogPostDAOImpl.findByPermalink(permalink);
                if (post == null) {
        ...
        post(new FreemarkerBasedRoute("/newpost", "newpost_template.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer)
                ...
                if (username == null) {
                    ...
                    String permalink = blogPostDAOImpl.addPost(title, post, tagsArray, username);
        ...
        post(new FreemarkerBasedRoute("/newcomment", "entry_template.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer)
                ...
                // check that comment is good
                    ...
                    blogPostDAOImpl.addPostComment(name, email, body, permalink);
                    response.redirect("/post/" + permalink);
                }
            }
        });
        ...
        get(new FreemarkerBasedRoute("/tag/:thetag", "blog_template.ftl") {
            ...
            protected void doHandle(Request request, Response response, Writer writer)
                ...
                List<DBObject> posts = blogPostDAOImpl.findByTagDateDescending(tag);
